...
Based on the AICc and AICw, it was determined that both perch height and diameter are significant predictors of hindlimb length in a phylogenetic context and the phylogenetically corrected hindlimb residuals that include perch height and diameter should be plotted to better understand the relationship between hindlimb length and SVL. This was demonstrated by our PGLS models, which confirmed that placement under Brownian Motion shows that specific traits of the hindlimb-SVL relationship evolved randomly. Furthermore, the residual plot suggests that there is a significant influence on the hindlimb-SVL relationship by phylogeny. 

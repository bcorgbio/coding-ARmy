...
# Load Data ---------------------------------------------------------------
  ...
  #CPK: ^ notice that your data are actually being read in from the base directory "coding-ARmy" even though they are in "Project 3"
...
# 6. Produce a plot of your own design to concisely visualize effe --------
  ...
  #CPK: Wow!!! Just wow! Excellent work. 
